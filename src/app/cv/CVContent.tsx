...
export default function CVContent({ initialData }: Props) {
  return (
    <div className="w-full h-screen">
      ...
      {/* Contenu scrollable */}
      <div className="h-[calc(100vh-53px)] overflow-y-auto hide-scrollbar pb-20 sm:pb-0">
        {/* Profil */}
            ...
            <div className="flex flex-wrap gap-2">
              {initialData.links.map((link, index) => (
                <a
                  ...
                  className="flex-1 sm:flex-none text-center px-4 py-2 bg-text_highlight text-white rounded-full font-bold hover:bg-text_highlight/90 transition-colors"
                >
                  {link.label}
                </a>
              ))}
