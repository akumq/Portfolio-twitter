...
export function VideoPlayer({ 
  ...
  return (
    ...
    >
      ...
      {/* Contrôles en bas */}
      <div 
        className={`video-controls absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 via-black/40 to-transparent pt-12 pb-2 px-4 transition-opacity duration-200 ${
      ...
      >
        ...
        <div 
          ref={progressBarRef}
          className="relative h-1 group/progress bg-white/30 rounded-full cursor-pointer mb-3"
