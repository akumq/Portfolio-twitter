  ...
  return (
    <div className="flex items-center justify-between max-w-md py-1">
      <button className="group flex items-center hover:text-blue-500 transition-colors">
        ...
        <span className="text-sm text-gray-500 group-hover:text-blue-500 ml-[2px]">{commits.toLocaleString()}</span>
      </button>
      ...
      <button className="group flex items-center hover:text-green-500 transition-colors">
        ...
        <span className="text-sm text-gray-500 group-hover:text-green-500 ml-[2px]">{watchers.toLocaleString()}</span>
      </button>
      ...
      <button className="group flex items-center hover:text-pink-500 transition-colors">
        ...
        <span className="text-sm text-gray-500 group-hover:text-pink-500 ml-[2px]">{stars.toLocaleString()}</span>
      </button>
    </div>
  );
} 