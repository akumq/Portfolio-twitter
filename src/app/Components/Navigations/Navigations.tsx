      ...
      <ul className="flex flex-col space-y-2">
        <Link href="/">
          <li className={`flex items-center p-3 rounded-full hover:bg-slate-500/10 transition-colors
            ...
            <span className="hidden lg:inline ml-5 text-xl">Projets</span>
          </li>
        </Link>
        ...
        <Link href="/cv">
          <li className={`flex items-center p-3 rounded-full hover:bg-slate-500/10 transition-colors
            ...
            <span className="hidden lg:inline ml-5 text-xl">CV</span>
          </li>
        </Link>

        <Link href="/entreprise">
          <li className={`flex items-center p-3 rounded-full hover:bg-slate-500/10 transition-colors
            ${pathname === "/entreprise" ? "font-bold" : ""}
            lg:px-4 lg:py-4`}>
            {pathname === "/entreprise" ? (
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-7">
            ...
            <span className="hidden lg:inline ml-5 text-xl">Entreprise</span>
          </li>
        </Link>
        ...
        <Link href="/competence">
          <li className={`flex items-center p-3 rounded-full hover:bg-slate-500/10 transition-colors
            ...
            <span className="hidden lg:inline ml-5 text-xl">Compétences</span>
          </li>
        </Link>
        ...
        <Link href="/contact">
          <li className={`flex items-center p-3 rounded-full hover:bg-slate-500/10 transition-colors
            ...
            <span className="hidden lg:inline ml-5 text-xl">Contact</span>
          </li>
        </Link>
      </ul>
    </div>
